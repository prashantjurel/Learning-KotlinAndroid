...
class PhrasesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        numbersList.add(Word("minto wuksus","Where are you going?",R.raw.phrase_where_are_you_going))
        numbersList.add(Word("tinnә oyaase'nә","What is your name?",R.raw.phrase_what_is_your_name))
        numbersList.add(Word("oyaaset..","My name is...",R.raw.phrase_my_name_is))
        numbersList.add(Word("michәksәs?","How are you feeling?",R.raw.phrase_how_are_you_feeling))
